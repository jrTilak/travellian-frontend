...
const Newsletter = () => {
  ...
  return (
    <div className="flex items-center justify-center sm:items-start lg:items-end sm:p-10 lg:py-14 lg:px-20 flex-col lg:flex-row lg:justify-between py-10 px-5 gap-10 rounded-3xl border-2 shadow-sm m-6 mb-0 max-w-[1262px] ">
